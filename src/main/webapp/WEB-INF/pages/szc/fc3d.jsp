...
<head>
    ...
    <title>福彩3d投注-福彩3D机选-福彩3d玩法-大奖网</title>
    <meta name="keywords" content="福彩3d投注,福彩3D机选,福彩3d玩法" />
    <meta name="description" content="大奖网数字彩频道提供福彩3d投注,并提供福彩3D机选和福彩3d玩法介绍,网上购买福彩3D就上大奖网彩票网.【大奖网彩票网-专业、安全的网上购彩平台】" />
    ...
    <div class="div_m">
        <div class="toptray-plus clearfix auto990">
            ...
            <div class="toptray-right fr">
                <ul class="toptray clearfix" id="toptray_login" style="display: block">
                    <li><a id="toptray_username" href="/blog/standings/66428">lotteryism...</a><a
                    ...
                    <li class="header-show-money">
                        <div id="wallet_container">
                            ...
                            <span class="colorRed" id="header_user_money" data-sh="0">*****</span><input type="hidden" value="0.00" id="header_user_money_hidden"/>
                ...
                <ul class="toptray-plus clearfix" id="toptray_not_login"style="display: none">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#szcpage").load("<%=request.getContextPath()%>/szc_fb/FC3D", function () { });
    });
...
<div class="hide">
<script src="http://s11.cnzz.com/z_stat.php?id=1261165287&web_id=1261165287" language="JavaScript"></script>
</div>
